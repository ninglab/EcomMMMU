...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_id", type=str, default="llava-interleave-qwen-7b")
...
#     --model_path checkpoints/llava-interleave-qwen-7b_mpc_blc \
#     --model_save_path /fs/scratch/PCON0041/xinyi/current/ckp_merged/r1_mpc_blc \
#     --load_model
    
#     --model_local_path checkpoints/llava-interleave-qwen-7b_mpc_blc \
    

# python merge_lora_weights.py \
#     --model_path checkpoints/4_llava_inf_r2_8 \
#     --model_save_path ckp_merged/4_llava_inf_r2_8 \
#     --load_model